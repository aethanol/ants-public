...
*/
class Insect {
    constructor(armor, place, action, watersafe) {
        this._armor = armor;
        this._place = place;
        ...
        this._watersafe = watersafe; // set watersafe strategy
...
class Ant extends Insect {
    constructor(armor, cost, action, visible, container, place) {
        super(armor, place);
        ...
        this._visible = visible; // set visible strategy
        this._container = container; // set container strategy
    }
    ...
    get contained(){
        if(this.container){ // check if has a container
            return this._container.ant;
        }
        
    }
    
    set contained(ant){
        this._container.ant = ant; // add ant to container  
    }
...
var Ants = {
    ...
    Scuba: class extends Ant {
        ...
        constructor() {
            ...
            this.range = 3;
            this.actName = 'Throw';
            this.watersafe = new Behaviors['Watersafe']();
        }
    ...
    Ninja: class extends Ant {
        ...
        constructor() {
            ...
            this.damage = 1;
            this.actName = 'Attack';
            this.visible = new Behaviors['Invisible']();
            // Ninjas are invisible -- kapow!
            //this.visible = false; 
        }
