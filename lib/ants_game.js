...
class Ant extends Insect {
  ...
  // abstract method
  act(colony){
      // DO NOTHING, meaning ants that do nothing don't even need to have act method
  }
...
class AntColony {
  ...
  deployAnt(place, ant){
    if(this._food >= ant.foodCost){
        if(place.water === true && ant.waterSafe === true || place. water === false && ant.waterSafe === false){ // check if place is water and ant is watersafe
